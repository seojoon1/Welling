...
function Org_ScoreComparison({ selectedRegion = '서울특별시', regionData = {} }) {
  // API에서 받은 데이터 또는 기본값
  const defaultData = { sentiment: 0, policy: 0, gap: 0 };
  const data = regionData[selectedRegion] || defaultData;
    ...
    <div className={styles.container}>
      ...
      <div className={styles.scoreGrid}>
        <div className={styles.scoreItem}>
          ...
          <div className={styles.scoreContent}>
            ...
            <div className={styles.value}>
              {Math.round(data.sentiment * 10) / 10}<span className={styles.maxValue}>/100</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.scoreItem}>
          ...
          <div className={styles.scoreContent}>
            ...
            <div className={styles.value}>
              {Math.round(data.policy * 10) / 10}<span className={styles.maxValue}>/100</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.scoreItem}>
          ...
          <div className={styles.scoreContent}>
            ...
            <div className={styles.value}>{Math.round(data.gap * 10) / 10}</div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.chartFrame}>
        <div className={styles.chartContainer}>
          <div className={styles.bar} style={{ height: `${data.sentiment * 1.65}px` }}>
